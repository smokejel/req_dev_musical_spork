...
### Phase 6: Energy Consumption Tracking (Week 4, Day 22)

**Goal:** Provide visibility into the environmental impact of LLM operations.

- **Phase 6.1:** Token-based energy estimation (Wh) with PUE overhead
- **Phase 6.2:** Energy coefficients for all 8 supported LLM models
- **Phase 6.3:** CLI display with contextual comparisons (TV, EV distance)
- **Phase 6.4:** Database persistence for energy metrics
